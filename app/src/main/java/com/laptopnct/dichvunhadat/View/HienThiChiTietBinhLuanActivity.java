...
import com.laptopnct.dichvunhadat.Control.Adapters.AdapterRecyclerHinhBinhLuan;
...
public class HienThiChiTietBinhLuanActivity extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        for (String linkhinh : binhLuanModel.getHinhanhBinhLuanList()){
            StorageReference storageHinhUser = FirebaseStorage.getInstance().getReference().child("hinhcongty").child(linkhinh);
